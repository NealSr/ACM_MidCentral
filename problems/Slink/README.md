# Slink
> Slitherlink puzzle from ACM Mid-Central 2007

The original problem this problemset was built from can be found at: http://www.icpc-midcentral.us/archives/2007/mcpc2007/browse.html

## Files:
  * [Input](input.txt) from http://www.icpc-midcentral.us/archives/2007/mcpc2007/slink/slink.in
  * [Output](output.txt) from http://www.icpc-midcentral.us/archives/2007/mcpc2007/slink/slink.out
...
<body style="background-color: white;" lang="EN-US">
   <h1 style="text-align: center;" align="center">Problem C: Slink</h1>
      ...
      <table>
         <tbody>
            <tr>
               ...
               <td><tt>slink.</tt>{<tt>c</tt>, <tt>cpp</tt>,
               <tt>java</tt>}</td>
            </tr>
   ...
   <p><img alt="slitherlink example" src="slitherlink.png"></p>
   ...
   <p><img alt="slink example" src="slink.png"></p>
   ...
   <p><b>Input:</b> The input for this problem is a set of Slink puzzles to be
   ...
   <p><b>Output:</b> The output for this problem is a graphical representation
